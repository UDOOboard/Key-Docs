...
Visit the [Get Started - ESP32 and IDF](/03_Get_Started/00_Get_started_with_ESP32_and_IDF.md), [Get Started - ESP32 and Arduino](/03_Get_Started/01_Get_started_with_ESP32_and_Arduino.md) [Get Started - RP2040 and MicroPython](/03_Get_Started/02_Get_started_with_RP2040_and_MicroPython.md) and [Get Started - RP2040 and Arduino](/03_Get_Started/03_Get_started_with_RP2040_and_Arduino.md) sections to learn how to start using your UDOO KEY.
